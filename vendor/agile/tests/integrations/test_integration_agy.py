...
class TestAgyBuildExecArgs:
    ...
    def test_build_exec_args_honors_extra_args(self, monkeypatch):
        """AGILE_INTEGRATION_AGY_EXTRA_ARGS must be appended after the prompt.
        ...
        """
        from agile_cli.integrations import get_integration
        monkeypatch.setenv("AGILE_INTEGRATION_AGY_EXTRA_ARGS", "--verbose")
        i = get_integration("agy")
    ...
    def test_build_exec_args_honors_executable_override(self, monkeypatch):
        from agile_cli.integrations import get_integration
        monkeypatch.setenv("AGILE_INTEGRATION_AGY_EXECUTABLE", "/custom/agy")
        i = get_integration("agy")
...
class TestAgyHookCommandNote:
    ...
    def test_hook_note_not_in_skills_without_hooks(self):
        ...
        from agile_cli.integrations.agy import AgyIntegration
