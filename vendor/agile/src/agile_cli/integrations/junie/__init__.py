...
def format_junie_command_name(cmd_name: str) -> str:
    ...
    Examples:
        ...
        'agile-plan'
        >>> format_junie_command_name("agile.plan")
        'agile-plan'
        >>> format_junie_command_name("agile.git.commit")
        'agile-git-commit'
...
class JunieIntegration(MarkdownIntegration):
    ...
    def build_command_invocation(self, command_name: str, args: str = "") -> str:
        """Junie installs hyphenated slash-commands (``/agile-<name>``), so the
        dispatch invocation must match. The inherited MarkdownIntegration default
        builds the dotted ``/agile.<name>``, which references a command Junie
