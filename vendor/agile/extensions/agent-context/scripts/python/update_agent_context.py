...
``.agile/feature.json`` (written by /agile-specify). Falls back to the most
...
def _resolve_plan_path(project_root: str) -> str:
    ...
    plan_path = ""
    feature_json = Path(project_root) / ".agile" / "feature.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    ext_config = (
        f"{project_root}/.agile/extensions/agent-context/agent-context-config.yml"
    )
