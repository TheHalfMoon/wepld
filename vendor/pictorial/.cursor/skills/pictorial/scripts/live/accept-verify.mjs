...
// completion gate.
const FORBIDDEN = [
  { marker: 'pictorial-variants-start', why: 'variant wrapper comment left in source' },
  { marker: 'pictorial-variants-end', why: 'variant wrapper comment left in source' },
  { marker: 'pictorial-carbonize-start', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'pictorial-carbonize-end', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'pictorial-param-values', why: 'param-values comment not baked and removed' },
  { marker: 'data-pictorial-', why: 'live-mode plumbing attribute left on markup' },
  ...
  { marker: '--pictorial-variant-ready', why: 'preview readiness sentinel left in CSS' },
];
