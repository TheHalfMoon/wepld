...
from agile_cli.bundler.models.catalog import CatalogSource, InstallPolicy
from agile_cli.bundler.services import adapters
...
def test_builtin_community_catalog_uses_core_pack_snapshot_offline(
    ...
    catalog_path.write_text(
        ...
        '"author":"Agile","license":"MIT","download_url":"",'
...
def test_validate_remote_url_rejects_host_less_urls(url):
    ...
    ``agile_cli.catalogs`` (#3210), which the docstring says this validator
    mirrors."""
