...
//
// Formats: PNG (tEXt chunk, keyword "pictorial:prompt"), JPEG (COM segment).
...
const KEYWORD = 'pictorial:prompt';
...
if (scanMode) {
  ...
  const walk = (p, isRoot) => {
    ...
    if (stat.isDirectory()) {
      ...
      // hidden dir the caller passed explicitly (e.g. .pictorial/mocks).
