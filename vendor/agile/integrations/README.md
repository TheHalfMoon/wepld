# Agile Integration Catalog

The integration catalog enables discovery, versioning, and distribution of AI agent integrations for Agile.

## Catalog Files

### Built-In Catalog (`catalog.json`)

Contains integrations that ship with Agile. These are maintained by the core team and always installable.
...
1. **Environment variable** — `AGILE_INTEGRATION_CATALOG_URL` overrides all catalogs with a single URL
2. **Project config** — `.agile/integration-catalogs.yml` in the project root
3. **User config** — `~/.agile/integration-catalogs.yml` in the user home directory
...
integration:
  ...
  author: "my-org"
  repository: "https://github.com/my-org/agile-my-agent"
  license: "MIT"
requires:
  agile_version: ">=0.6.0"
  tools:
