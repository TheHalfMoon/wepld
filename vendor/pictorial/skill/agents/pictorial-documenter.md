---
name: pictorial-documenter
codex-name: pictorial_documenter
description: Records DESIGN.md and its sidecar from a finished Pictorial build, deriving the design system from the shipped artifact rather than from intentions.
