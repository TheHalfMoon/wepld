import pytest
import yaml
from agile_cli.extensions import HookExecutor, ExtensionManifest
...
class TestExtensionRegistration:
    ...
    def test_register_hooks_triggers_registration(self, project_dir, tmp_path):
        ...
        manifest_data = {
            ...
            "provides": {"commands": []},
            "hooks": {
                "after_tasks": {"command": "agile.hook-ext.run"}
            }
        }
    ...
    def test_unregister_hooks_with_multiple_extensions(self, project_dir, tmp_path):
        ...
        manifest_data_1 = {
            ...
            "provides": {"commands": []},
            "hooks": {
                "after_tasks": {"command": "agile.ext-1.run"}
            }
        }
        manifest_data_2 = {
            "schema_version": "1.0",
            ...
            "provides": {"commands": []},
            "hooks": {
                "after_tasks": {"command": "agile.ext-2.run"}
            }
        }
    ...
    def test_register_hooks_no_hooks_still_registers(self, project_dir, tmp_path):
        ...
        manifest_data = {
            ...
            "provides": {"commands": [{"name": "agile.commands-only-ext.run", "file": "commands/run.md"}]},
        }
        manifest_path = tmp_path / "extension.yml"
        with open(manifest_path, "w") as f:
            yaml.dump(manifest_data, f)
    ...
    def test_register_hooks_corrupted_hook_values(self, project_dir, tmp_path):
        ...
        manifest_data = {
            ...
            "provides": {"commands": []},
            "hooks": {"after_tasks": {"command": "agile.new-ext.run"}}
        }
        manifest_path = tmp_path / "extension.yml"
        with open(manifest_path, "w") as f:
            yaml.dump(manifest_data, f)
