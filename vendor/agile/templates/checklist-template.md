...
**Note**: This custom checklist is generated by the `__AGILE_COMMAND_CHECKLIST__` command based on feature context and requirements.
...
<!--
  ...
  The __AGILE_COMMAND_CHECKLIST__ command MUST replace these with actual items based on:
