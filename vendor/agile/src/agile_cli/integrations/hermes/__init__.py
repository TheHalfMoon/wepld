...
Usage::
    ...
    agile init my-project --integration hermes
    agile init --here --integration hermes
"""
...
class HermesIntegration(SkillsIntegration):
    ...
    both the marker and all global ``agile-*`` skills, matching the
    ...
    def setup(
        ...
        **opts: Any,
        ...
        ``~/.hermes/skills/agile-<name>/SKILL.md`` where Hermes
        ...
        for src_file in templates:
            ...
            skill_content = (
                ...
                f"compatibility: "
                f"{yaml_quote('Requires agile project structure with .agile/ directory')}\n"
                f"metadata:\n"
            ...
            # Write directly to global ~/.hermes/skills/agile-<name>/SKILL.md
    ...
    def teardown(
        ...
        *,
        ...
        removes all ``agile-*`` skills under ``~/.hermes/skills/``.
        ...
        # Remove all global Hermes skills for agile — these are always
        ...
        if global_skills_dir.is_dir():
            for skill_dir in sorted(global_skills_dir.iterdir()):
                if skill_dir.is_dir() and skill_dir.name.startswith("agile-"):
                    try:
                        rmtree(skill_dir)
    ...
    def build_exec_args(
        ...
        *,
        ...
        # Operator-supplied AGILE_INTEGRATION_HERMES_EXTRA_ARGS go here —
        # after the base command but before Agile's canonical -m/--json/-s/-q
