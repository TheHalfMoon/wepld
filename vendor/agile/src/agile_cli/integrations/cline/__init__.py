...
def format_cline_command_name(cmd_name: str) -> str:
    ...
    Examples:
        ...
        'agile-plan'
        >>> format_cline_command_name("agile.plan")
        'agile-plan'
        >>> format_cline_command_name("agile.git.commit")
        'agile-git-commit'
    ...
    if not cmd_name.startswith("agile-"):
        cmd_name = f"agile-{cmd_name}"
...
class ClineIntegration(MarkdownIntegration):
    ...
    def command_filename(self, template_name: str) -> str:
        """Cline uses hyphenated filenames (e.g. agile-git-commit.md)."""
    ...
    def build_command_invocation(self, command_name: str, args: str = "") -> str:
        ...
        builds the dotted ``/agile.<name>``, which references a command Cline
    ...
    def _rewrite_handoff_references(content: str) -> str:
        ...
        return re.sub(
            r"(?m)^(\s*agent:\s*)(agile\.[A-Za-z0-9-_]+(?:\.[A-Za-z0-9-_]+)*)",
