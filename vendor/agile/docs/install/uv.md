...
[uv](https://docs.astral.sh/uv/) is a fast Python package manager by [Astral](https://astral.sh/). Agile uses `uv` (via `uvx` or `uv tool install`) to run the `agile` CLI without polluting your global Python environment.
