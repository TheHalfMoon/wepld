...
Agile intentionally leaves teams in control of what happens to `spec.md`,
...
None is the default, and none is required by Agile.
...
Agile also exposes a second question: what happens to the artifact set when
