...
1. Read `.agile/feature.json` to get the feature directory path.

2. **Load context**: `.agile/memory/constitution.md` and `<feature_directory>/spec.md` and `<feature_directory>/plan.md` and `<feature_directory>/tasks.md`.
