...
from agile_cli.integrations.alquimia import ARGUMENT_HINTS
...
class TestAlquimiaAIIntegration:
    ...
    def test_setup_creates_skill_files(self, tmp_path):
        ...
        assert "/agile." not in content, (
            "skills agent must use /agile-<name> not /agile.<name>"
        )
    ...
    def test_integration_flag_creates_skill_files_cli(self, tmp_path):
        ...
        assert (project / ".alquimia" / "skills" / "agile-plan" / "SKILL.md").exists()
    ...
    def test_integration_flag_creates_skill_files(self, tmp_path):
        ...
        assert result.exit_code == 0, result.output
        assert (
            project / ".alquimia" / "skills" / "agile-specify" / "SKILL.md"
        ).exists()
        assert (
            project / ".agile" / "integrations" / "alquimia.manifest.json"
        ).exists()
    ...
    def test_interactive_alquimia_selection_uses_integration_path(self, tmp_path):
        ...
        try:
            ...
            with (
                ...
                patch(
                    "agile_cli.commands.init.select_with_arrows",
        ...
        skill_file = project / ".alquimia" / "skills" / "agile-plan" / "SKILL.md"
    ...
    def test_alquimia_init_remains_usable_when_converter_fails(self, tmp_path):
        ...
        assert (
            target / ".alquimia" / "skills" / "agile-specify" / "SKILL.md"
        ).exists()
    ...
    def test_alquimia_preset_creates_new_skill_without_commands_dir(self, tmp_path):
        ...
        assert "agile-research" in metadata.get("registered_skills", {}).get(
            "alquimia", []
        )
...
class TestAlquimiaArgumentHints:
    ...
    def test_inject_argument_hint_only_in_frontmatter(self):
        ...
        from agile_cli.integrations.alquimia import AlquimiaAIIntegration
...
class TestAlquimiaHookCommandNote:
    ...
    def test_hook_note_injected_in_skills_with_hooks(self, tmp_path):
        ...
        specify_skill = tmp_path / ".alquimia/skills/agile-specify/SKILL.md"
