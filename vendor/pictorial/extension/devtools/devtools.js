...
/**
 * Pictorial DevTools Extension - DevTools Page
 *
 * Creates the Pictorial panel and triggers an auto-scan when DevTools opens.
...
chrome.devtools.panels.elements.createSidebarPane('Pictorial', (sidebar) => {
...
const portName = `pictorial-devtools-${chrome.devtools.inspectedWindow.tabId}`;
...
function connectLifecycle() {
  ...
  // Default ('panel'): wait until the user opens the Pictorial panel or sidebar.
