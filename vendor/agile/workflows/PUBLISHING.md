...
This guide explains how to publish your workflow to the Agile workflow catalog, making it discoverable by `specify workflow search`.
...
```text
https://raw.githubusercontent.com/your-org/agile-workflow-your-workflow/v1.0.0/workflow.yml
```
...
Agile uses a dual-catalog system:
...
```json
{
  ...
  "workflows": {
    "your-workflow": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "url": "https://raw.githubusercontent.com/your-org/agile-workflow-your-workflow/v1.0.0/workflow.yml",
      "repository": "https://github.com/your-org/agile-workflow-your-workflow",
      "license": "MIT",
      "requires": {
        "agile_version": ">=0.15.0"
      },
      "tags": [
        "category",
        "automation"
...
- **Shell runs with the user's privileges** — a `shell` step executes a local command directly; there is no capability sandbox. `requires` is an advisory pre-condition block (recognised keys: `agile_version`, `integrations`), **not** a runtime permission gate — there is no `requires.permissions`. Gate sensitive commands explicitly with a `gate` step.
