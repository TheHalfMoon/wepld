...
def project_dir(temp_dir):
    """Create a mock agile project with .agile/ directory."""
    specify_dir = temp_dir / ".agile"
    specify_dir.mkdir()
...
def sample_workflow_file(project_dir, sample_workflow_yaml):
    ...
    wf_dir = project_dir / ".agile" / "workflows" / "test-workflow"
...
class TestStepRegistry:
    ...
    def test_registry_populated(self):
        from agile_cli.workflows import STEP_REGISTRY
    ...
    def test_get_step_type(self):
        from agile_cli.workflows import get_step_type
    ...
    def test_register_step_duplicate_raises(self):
        from agile_cli.workflows import _register_step
        from agile_cli.workflows.steps.command import CommandStep
    ...
    def test_register_step_empty_key_raises(self):
        from agile_cli.workflows import _register_step
        from agile_cli.workflows.base import StepBase, StepResult
...
class TestBaseClasses:
    ...
    def test_step_context_defaults(self):
        from agile_cli.workflows.base import StepContext
    ...
    def test_step_result_defaults(self):
        from agile_cli.workflows.base import StepResult, StepStatus
    ...
    def test_step_status_values(self):
        from agile_cli.workflows.base import StepStatus
    ...
    def test_run_status_values(self):
        from agile_cli.workflows.base import RunStatus
...
class TestExpressions:
    ...
    def test_simple_variable(self):
        from agile_cli.workflows.expressions import evaluate_expression
        from agile_cli.workflows.base import StepContext
    ...
    def test_step_output_reference(self):
        ...
        ctx = StepContext(
            steps={"agile": {"output": {"file": "spec.md"}}}
        )
        assert evaluate_expression("{{ steps.agile.output.file }}", ctx) == "spec.md"
    ...
    def test_operator_splitting_is_quote_aware(self):
        from agile_cli.workflows.expressions import (
            evaluate_condition,
            evaluate_expression,
        )
        from agile_cli.workflows.base import StepContext
    ...
    def test_condition_evaluation(self):
        from agile_cli.workflows.expressions import evaluate_condition
        from agile_cli.workflows.base import StepContext
...
class TestBuildExecArgs:
    ...
    def test_claude_exec_args(self):
        from agile_cli.integrations.claude import ClaudeIntegration
    ...
    def test_gemini_exec_args(self):
        from agile_cli.integrations.gemini import GeminiIntegration
    ...
    def test_codex_exec_args(self):
        from agile_cli.integrations.codex import CodexIntegration
    ...
    def test_copilot_exec_args(self, monkeypatch):
        monkeypatch.delenv("AGILE_COPILOT_ALLOW_ALL_TOOLS", raising=False)
        monkeypatch.delenv("AGILE_ALLOW_ALL_TOOLS", raising=False)
        from agile_cli.integrations.copilot import CopilotIntegration
    ...
    def test_copilot_new_env_var_disables_yolo(self, monkeypatch):
        monkeypatch.setenv("AGILE_COPILOT_ALLOW_ALL_TOOLS", "0")
        monkeypatch.delenv("AGILE_ALLOW_ALL_TOOLS", raising=False)
        from agile_cli.integrations.copilot import CopilotIntegration
        impl = CopilotIntegration()
        args = impl.build_exec_args("do stuff")
    ...
    def test_copilot_deprecated_env_var_still_honoured(self, monkeypatch):
        monkeypatch.delenv("AGILE_COPILOT_ALLOW_ALL_TOOLS", raising=False)
        monkeypatch.setenv("AGILE_ALLOW_ALL_TOOLS", "0")
        import warnings
        from agile_cli.integrations.copilot import CopilotIntegration
        impl = CopilotIntegration()
        ...
        assert "--yolo" not in args
        assert any(
            "AGILE_ALLOW_ALL_TOOLS is deprecated" in str(x.message)
            and issubclass(x.category, UserWarning)
            for x in w
        )

    def test_copilot_new_env_var_takes_precedence(self, monkeypatch):
        monkeypatch.setenv("AGILE_COPILOT_ALLOW_ALL_TOOLS", "1")
        monkeypatch.setenv("AGILE_ALLOW_ALL_TOOLS", "0")
        from agile_cli.integrations.copilot import CopilotIntegration
        impl = CopilotIntegration()
        args = impl.build_exec_args("do stuff")
    ...
    def test_ide_only_returns_none(self):
        from agile_cli.integrations.kilocode import KilocodeIntegration
    ...
    def test_rovodev_exec_args(self):
        from agile_cli.integrations.rovodev import RovodevIntegration

        impl = RovodevIntegration()
        args = impl.build_exec_args("/agile.plan add OAuth")
        assert args[0:3] == ["acli", "rovodev", "run"]
        assert args[3] == "/agile.plan add OAuth"
...
class TestCommandStep:
    ...
    def test_execute_basic(self):
        ...
        from agile_cli.workflows.steps.command import CommandStep
        from agile_cli.workflows.base import StepContext, StepStatus
    ...
    def test_try_dispatch_resolves_rovodev_via_acli(self, tmp_path):
        ...
        with patch("agile_cli.workflows.steps.command.shutil.which",
    ...
    def test_dispatch_with_mock_cli(self, tmp_path, monkeypatch):
        ...
        with patch("agile_cli.workflows.steps.command.shutil.which", return_value="/usr/local/bin/claude"), \
             patch("agile_cli.integrations.base.shutil.which", return_value="/usr/local/bin/claude"), \
        ...
        # Claude is a SkillsIntegration so uses /agile-specify
        assert "/agile-specify login" in call_args[0][0][2]
    ...
    def test_dispatch_uses_executable_override_for_fallback_preflight(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("AGILE_INTEGRATION_CLAUDE_EXECUTABLE", "/opt/claude")
        seen_which: list[str] = []
        ...
        with patch("agile_cli.workflows.steps.command.shutil.which", side_effect=fake_which), \
             patch("subprocess.run", return_value=mock_result) as mock_run:
            result = step.execute(config, ctx)
...
class TestPromptStep:
    ...
    def test_execute_basic(self):
        from unittest.mock import patch
        from agile_cli.workflows.steps.prompt import PromptStep
        from agile_cli.workflows.base import StepContext, StepStatus
        ...
        with patch("agile_cli.workflows.steps.prompt.shutil.which", return_value=None):
            result = step.execute(config, ctx)
        assert result.status == StepStatus.FAILED
    ...
    def test_try_dispatch_resolves_rovodev_via_acli(self, tmp_path):
        ...
        with patch("agile_cli.workflows.steps.prompt.shutil.which",
                    lambda name: "/usr/bin/acli" if name == "acli" else None), \
             patch("subprocess.run", return_value=mock_result):
            result = step.execute(config, ctx)
    ...
    def test_try_dispatch_executes_the_resolved_executable(self, tmp_path):
        ...
        with patch(
            "agile_cli.workflows.steps.prompt.shutil.which",
    ...
    def test_dispatch_with_mock_cli(self, tmp_path):
        ...
        with patch("agile_cli.workflows.steps.prompt.shutil.which", return_value="/usr/local/bin/claude"), \
             patch("subprocess.run", return_value=mock_result):
            result = step.execute(config, ctx)
    ...
    def test_dispatch_uses_executable_override_for_fallback_preflight(self, tmp_path, monkeypatch):
        ...
        with patch("agile_cli.workflows.steps.prompt.shutil.which", side_effect=fake_which), \
             patch("subprocess.run", return_value=mock_result) as mock_run:
            result = step.execute(config, ctx)
...
class TestShellStep:
    ...
    def test_execute_echo(self):
        from agile_cli.workflows.steps.shell import ShellStep
        from agile_cli.workflows.base import StepContext, StepStatus
    ...
    def test_validate_workflow_reports_huge_int_timeout(self):
        ...
        """
        from agile_cli.workflows.engine import WorkflowDefinition, validate_workflow
...
def _force_gate_stdin(monkeypatch, *, tty: bool):
    from agile_cli.workflows.steps import gate as gate_module
...
class TestInitStep:
    ...
    def test_docstring_lists_every_valid_script_type(self):
        ...
        from agile_cli.workflows.steps.init import InitStep, VALID_SCRIPT_TYPES
    ...
    def test_builds_here_argv_and_bootstraps(self, tmp_path):
        from agile_cli.workflows.steps.init import InitStep
        from agile_cli.workflows.base import StepContext, StepStatus
    ...
    def test_default_integration_honors_env_var(self, tmp_path, monkeypatch):
        ...
        # AGILE_INTEGRATION_DEFAULT value must drive both output.integration
        # and the argv passed to init (guards against reverting to the constant).
        from agile_cli.workflows.steps.init import InitStep
        from agile_cli.workflows.base import StepContext, StepStatus

        monkeypatch.setenv("AGILE_INTEGRATION_DEFAULT", "gemini")
        step = InitStep()
        ctx = StepContext(project_root=str(tmp_path))
        result = step.execute(
            {"id": "bootstrap", "here": True, "script": "sh"}, ctx
    ...
    def test_project_name_creates_subdirectory(self, tmp_path):
        ...
        assert result.status == StepStatus.COMPLETED
        assert (tmp_path / "demo" / ".agile").is_dir()
    ...
    def test_non_empty_current_dir_without_force_fails_fast(self, tmp_path):
        ...
        assert not (tmp_path / ".agile").exists()
    ...
    def test_engine_owned_dirs_do_not_trigger_non_empty_check(self, tmp_path):
        ...
        (tmp_path / ".agile" / "workflows" / "runs" / "abc123").mkdir(
            parents=True
        )
...
class TestGateStep:
    ...
    def test_docstring_lists_every_on_reject_behaviour(self):
        ...
        from agile_cli.workflows.steps.gate import GateStep
    ...
    def test_failed_gate_persists_error_in_step_results(
        ...
        from agile_cli.workflows.engine import WorkflowEngine
...
class TestIfThenStep:
    ...
    def test_execute_then_branch(self):
        from agile_cli.workflows.steps.if_then import IfThenStep
        from agile_cli.workflows.base import StepContext
        ...
        config = {
            ...
            "then": [{"id": "a", "command": "agile.tasks"}],
            "else": [{"id": "b", "command": "agile.plan"}],
        }
        result = step.execute(config, ctx)
...
class TestSwitchStep:
    ...
    def test_execute_matches_case_ignoring_surrounding_whitespace(self):
        ...
        workflow author cannot strip it themselves.
        """
        from agile_cli.workflows.steps.switch import SwitchStep
        from agile_cli.workflows.base import StepContext, StepStatus
    ...
    def test_execute_matches_case(self):
        ...
        config = {
            ...
            "cases": {
                "approve": [{"id": "plan", "command": "agile.plan"}],
        ...
        result = step.execute(
            {
                "id": "route",
                "expression": "{{ steps.review.output.choice }}",
                "cases": {"approve": [{"id": "plan", "command": "agile.plan"}]},
                "default": bad_branch,
            },
            ctx,
        )
...
class TestWhileStep:
    ...
    def test_execute_condition_true(self):
        from agile_cli.workflows.steps.while_loop import WhileStep
        from agile_cli.workflows.base import StepContext
        ...
        config = {
            ...
            "max_iterations": 5,
            "steps": [{"id": "fix", "command": "agile.implement"}],
        }
        result = step.execute(config, ctx)
        assert result.output["condition_result"] is True
        assert len(result.next_steps) == 1
...
class TestDoWhileStep:
    ...
    def test_execute_always_runs_once(self):
        from agile_cli.workflows.steps.do_while import DoWhileStep
        from agile_cli.workflows.base import StepContext
    ...
    def test_execute_with_true_condition(self):
        ...
        config = {
            ...
            "condition": "{{ true }}",
            "max_iterations": 5,
            "steps": [{"id": "work", "command": "agile.plan"}],
        }
        result = step.execute(config, ctx)
...
class TestFanOutStep:
    ...
    def test_execute_with_items(self):
        from agile_cli.workflows.steps.fan_out import FanOutStep
        from agile_cli.workflows.base import StepContext
        ...
        config = {
            ...
            "max_concurrency": 3,
            "step": {"id": "impl", "command": "agile.implement"},
        }
        result = step.execute(config, ctx)
...
class TestFanInStep:
    ...
    def test_execute_collects_results(self):
        from agile_cli.workflows.steps.fan_in import FanInStep
        from agile_cli.workflows.base import StepContext
...
class TestFanOutConcurrency:
    ...
    def _build(tmp_path, on_item=None):
        ...
        """
        from agile_cli.workflows.base import (
            RunStatus,
            StepBase,
            StepContext,
            StepResult,
        ...
        from agile_cli.workflows.engine import RunState, WorkflowEngine
    ...
    def test_marks_item_context_as_inside_fan_out(self, tmp_path, max_concurrency):
        from agile_cli.workflows.base import StepBase, StepResult, StepStatus
    ...
    def test_concurrent_halt_status_not_clobbered_by_later_item(self, tmp_path):
        ...
        from agile_cli.workflows.base import RunStatus, StepStatus
    ...
    def test_unknown_template_type_halts_concurrent_like_sequential(self, tmp_path):
        ...
        from agile_cli.workflows.base import RunStatus, StepContext
        from agile_cli.workflows.engine import RunState, WorkflowEngine
...
class TestFanInWaitForValidation:
    ...
    def _errors(yaml_text):
        from agile_cli.workflows.engine import (
            WorkflowDefinition,
            validate_workflow,
        )
...
class TestWorkflowDefinition:
    ...
    def test_from_yaml(self, sample_workflow_file):
        from agile_cli.workflows.engine import WorkflowDefinition
    ...
    def test_resolve_inputs_tolerates_non_mapping_inputs(self, block):
        ...
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine
...
""")
    ...
    def test_retry_verdict_enum_wedge_is_reachable_end_to_end(self, tmp_path):
        ...
        wf_dir = tmp_path / ".agile" / "workflows" / "wf"
...
class TestWorkflowEngine:
    ...
    def test_execute_rejects_invalid_workflow_dispatch_defaults(
        ...
        assert not (project_dir / ".agile" / "workflows" / "runs").exists()
    ...
    def test_execute_simple_workflow(self, project_dir):
        from unittest.mock import patch
        from agile_cli.workflows.engine import WorkflowEngine, WorkflowDefinition
        from agile_cli.workflows.base import RunStatus
...
"""
    ...
    def test_integration_auto_default_uses_project_integration(self, project_dir):
        """`integration: auto` should resolve to .agile/integration.json's integration."""
        from agile_cli.workflows.engine import WorkflowEngine, WorkflowDefinition
...
""")
    ...
    def test_integration_auto_default_falls_back_when_no_integration_json(self, project_dir):
        ...
        ``.agile/integration.json`` is absent; any later validation or
...
""")
    ...
    def test_integration_auto_rejects_future_state_schema(self, project_dir):
        ...
        from agile_cli.workflows.engine import WorkflowEngine, WorkflowDefinition
        from agile_cli.integration_state import INTEGRATION_STATE_SCHEMA
...
""")
    ...
    def test_while_loop_condition_reads_latest_iteration(self, project_dir):
        ...
        See https://github.com/TheHalfMoon/wepld/issues/2592
        """
        from agile_cli.workflows.engine import WorkflowEngine, WorkflowDefinition
        from agile_cli.workflows.base import RunStatus
...
""")
        engine = WorkflowEngine(project_dir)
        with patch(
            "agile_cli.workflows.steps.command.shutil.which",
            return_value=None,
        ):
...
""")
    ...
    def test_run_id_uses_agile_workflow_run_id_env_override(self, project_dir, monkeypatch):
        """When no run_id argument is provided, AGILE_WORKFLOW_RUN_ID overrides the auto-generated run ID."""
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine

        monkeypatch.setenv("AGILE_WORKFLOW_RUN_ID", "env-run-123")
        definition = WorkflowDefinition.from_string("""
schema_version: "1.0"
workflow:
  id: "env-run-id"
...
""")
    ...
    def test_run_id_arg_takes_precedence_over_env_override(self, project_dir, monkeypatch):
        """Explicit run_id keeps existing precedence over AGILE_WORKFLOW_RUN_ID."""
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine
...
class TestContextWorkflowDir:
    """Tests for `{{ context.workflow_dir }}` and `AGILE_WORKFLOW_DIR`."""
...
""")
    ...
    def test_shell_step_receives_agile_workflow_dir_env_var(self, project_dir):
        """Shell steps receive AGILE_WORKFLOW_DIR in their environment."""
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine
        import sys
...
steps:
  - id: print-env
    type: shell
    run: '"{python}" -c "import os; print(os.environ.get(''AGILE_WORKFLOW_DIR'', ''UNSET''))"'
""")
        definition = WorkflowDefinition.from_yaml(wf_file)
        engine = WorkflowEngine(project_dir)
        state = engine.execute(definition)
    ...
    def test_shell_step_no_env_var_when_workflow_dir_unset(self, project_dir, monkeypatch):
        """Shell steps do not set AGILE_WORKFLOW_DIR for string-loaded workflows."""
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine
        import sys

        monkeypatch.delenv("AGILE_WORKFLOW_DIR", raising=False)
...
""")
        ...
        from unittest.mock import patch
        from agile_cli.workflows.base import StepResult

        with patch(
            "agile_cli.workflows.steps.gate.GateStep.execute",
    ...
    def test_workflow_dir_persisted_in_state(self, project_dir):
        ...
        from agile_cli.workflows.engine import WorkflowDefinition, WorkflowEngine, RunState
...
""")
    ...
    def test_installed_workflow_has_workflow_dir(self, project_dir):
        ...
        installation directory (.agile/workflows/<id>/).
        """
        from agile_cli.workflows.engine import WorkflowEngine
        from agile_cli.workflows.base import RunStatus

        wf_id = "installed-wfdir"
        install_dir = project_dir / ".agile" / "workflows" / wf_id
...
class TestRunState:
    ...
    def test_save_and_load(self, project_dir):
        from agile_cli.workflows.engine import RunState
        from agile_cli.workflows.base import RunStatus
    ...
    def test_load_rejects_path_traversal(self, project_dir, malicious_run_id):
        ...
        JSON from outside ``.agile/workflows/runs/``. The check must
        ...
        # not-found case).
        runs_dir = project_dir / ".agile" / "workflows" / "runs"
        runs_dir.mkdir(parents=True, exist_ok=True)
        attacker_dir = project_dir / ".agile" / "workflows" / "escape"
...
class TestWorkflowRegistry:
    ...
    def test_add_and_get(self, project_dir):
        from agile_cli.workflows.catalog import WorkflowRegistry
    ...
    def test_remove_rolls_back_in_memory_on_save_failure(
        ...
        from agile_cli.workflows.catalog import WorkflowRegistry
        import agile_cli.workflows.catalog as catalog_mod
    ...
    def test_load_symlinked_workflows_dir_fails_closed_not_silently_empty(
        ...
        """A symlinked .agile/workflows is the same fail-open hazard as a
        ...
        workflows_link = project_dir / ".agile" / "workflows"
...
class TestWorkflowCatalog:
    ...
    def test_non_mapping_cache_metadata_is_invalid(
        ...
        from agile_cli.workflows.catalog import StepCatalog, WorkflowCatalog
    ...
    def test_non_mapping_cached_workflow_catalog_is_refetched(
        ...
        from agile_cli.authentication import http as auth_http
        from agile_cli.workflows.catalog import (
            WorkflowCatalog,
    ...
    def test_search_with_non_string_fields(self, project_dir, monkeypatch):
        ...
        from agile_cli.workflows.catalog import WorkflowCatalog
    ...
    def test_default_catalogs(self, project_dir, monkeypatch):
        ...
        monkeypatch.delenv("AGILE_WORKFLOW_CATALOG_URL", raising=False)
        catalog = WorkflowCatalog(project_dir)
    ...
    def test_env_var_override(self, project_dir, monkeypatch):
        ...
        monkeypatch.setenv("AGILE_WORKFLOW_CATALOG_URL", "https://example.com/catalog.json")
        catalog = WorkflowCatalog(project_dir)
        entries = catalog.get_active_catalogs()
    ...
    def test_project_level_config(self, project_dir):
        ...
        config_path = project_dir / ".agile" / "workflow-catalogs.yml"
    ...
    def test_falsy_non_mapping_config_rejected(self, project_dir, body):
        ...
        from agile_cli.workflows.catalog import WorkflowCatalog, WorkflowValidationError
    ...
    def test_validate_url_malformed_raises_validation_error(self, project_dir, url):
        ...
        clean 'Error:' message + exit 1. Mirrors agile_cli.catalogs (#3435).
        """
        from agile_cli.workflows.catalog import (
            WorkflowCatalog,
    ...
    def test_fetch_malformed_redirect_target_raises_catalog_error(
        ...
        target. Mirrors agile_cli.catalogs (#3435).
        """
        from agile_cli.workflows.catalog import (
            WorkflowCatalog,
            WorkflowCatalogEntry,
    ...
    def test_fetch_rejects_oversized_catalog_response(
        ...
        from agile_cli.authentication import http as auth_http
        from agile_cli.workflows import catalog as catalog_module
        from agile_cli.workflows.catalog import (
            WorkflowCatalog,
            WorkflowCatalogEntry,
            WorkflowCatalogError,
...
"""
        ...
        assert state.status == RunStatus.COMPLETED
        assert "agile" in state.step_results
...
class TestStepRegistryCustom:
    ...
    def test_add_and_get(self, project_dir):
        from agile_cli.workflows.catalog import StepRegistry
    ...
    def test_registry_load_refuses_symlinked_steps_dir(self, project_dir):
        ...
        steps_link = project_dir / ".agile" / "workflows" / "steps"
    ...
    def test_registry_save_refuses_symlinked_steps_dir(self, project_dir):
        ...
        from agile_cli.workflows.catalog import StepRegistry, StepValidationError
...
class TestStepCatalog:
    ...
    def test_falsy_non_mapping_config_rejected(self, project_dir, body):
        ...
        from agile_cli.workflows.catalog import StepCatalog, StepValidationError

        config_path = project_dir / ".agile" / "step-catalogs.yml"
        config_path.write_text(body, encoding="utf-8")
    ...
    def test_empty_or_null_config_is_noop(self, project_dir, body):
        ...
        through."""
        from agile_cli.workflows.catalog import StepCatalog
    ...
    def test_default_catalogs(self, project_dir, monkeypatch):
        ...
        monkeypatch.setattr(Path, "home", lambda: project_dir)
        monkeypatch.delenv("AGILE_STEP_CATALOG_URL", raising=False)
        catalog = StepCatalog(project_dir)
        entries = catalog.get_active_catalogs()
        assert len(entries) == 2
        assert entries[0].name == "default"
    ...
    def test_env_var_override(self, project_dir, monkeypatch):
        ...
        monkeypatch.setenv("AGILE_STEP_CATALOG_URL", "https://example.com/step-catalog.json")
        catalog = StepCatalog(project_dir)
        entries = catalog.get_active_catalogs()
        assert len(entries) == 1
        assert entries[0].name == "env-override"
    ...
    def test_validate_url_malformed_raises_validation_error(self, project_dir, url):
        ...
        StepValidationError). Mirrors agile_cli.catalogs (#3435).
        """
        from agile_cli.workflows.catalog import StepCatalog, StepValidationError
    ...
    def test_fetch_malformed_redirect_target_raises_catalog_error(
        ...
        Mirrors agile_cli.catalogs (#3435).
        """
        from agile_cli.workflows.catalog import (
            StepCatalog,
            StepCatalogEntry,
    ...
    def test_get_merged_steps_normalizes_list_ids_to_strings(self, project_dir, monkeypatch):
        ...
        from agile_cli.workflows.catalog import StepCatalog, StepCatalogEntry
...
class TestLoadCustomSteps:
    ...
    def test_empty_steps_dir(self, project_dir):
        from agile_cli.workflows import load_custom_steps
    ...
    def test_no_steps_dir(self, project_dir):
        ...
        # .agile/workflows/steps does not exist
        loaded = load_custom_steps(project_dir)
        assert loaded == []

    def test_load_valid_custom_step(self, project_dir):
        from agile_cli.workflows import load_custom_steps, STEP_REGISTRY

        step_dir = project_dir / ".agile" / "workflows" / "steps" / "test-custom"
...
"""
    ...
    def test_skip_missing_step_yml(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "bad-step"
        step_dir.mkdir(parents=True)
    ...
    def test_skip_missing_init_py(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "bad-step2"
        step_dir.mkdir(parents=True)
    ...
    def test_skip_symlinked_step_files(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "bad-symlinked-files"
        step_dir.mkdir(parents=True)
    ...
    def test_skip_already_registered(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "command"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
            "step:\n  type_key: command\n", encoding="utf-8"
        )
    ...
    def test_skip_broken_init_py(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "broken-step"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
    ...
    def test_module_name_sanitized_for_hyphenated_type_key(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "my-hyphen-step"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
...
"""
        ...
        module_name = f"_agile_custom_step_my_hyphen_step_{key_hash}"
    ...
    def test_package_relative_import(self, project_dir):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "pkg-step"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
            "step:\n  type_key: pkg-step\n  name: Package Step\n",
            encoding="utf-8",
...
"""
        ...
        module_name = f"_agile_custom_step_pkg_step_{key_hash}"
        assert module_name in sys.modules
    ...
    def test_module_name_collision_resistance(self, project_dir):
        ...
        def make_module_name(type_key: str) -> str:
            ...
            return f"_agile_custom_step_{safe_key}_{key_hash}"
...
class TestWorkflowStepRemoveCLI:
    ...
    def test_remove_orphaned_directory(self, project_dir, monkeypatch):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "orphan-step"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
    ...
    def test_remove_registered_step(self, project_dir, monkeypatch):
        ...
        step_dir = project_dir / ".agile" / "workflows" / "steps" / "my-step"
        step_dir.mkdir(parents=True)
        (step_dir / "step.yml").write_text(
            "step:\n  type_key: my-step\n", encoding="utf-8"
        )
...
class TestWorkflowRemoveGuard:
    def test_remove_rejects_traversal_registry_key(self, project_dir, monkeypatch):
        ...
        outside = project_dir / ".agile" / "outside"
        outside.mkdir()
    ...
    def test_remove_rejects_reserved_storage_ids(
        ...
        reserved_dir = project_dir / ".agile" / "workflows" / workflow_id
    ...
    def test_remove_refuses_symlinked_workflow_dir(self, project_dir, monkeypatch):
        ...
        sentinel = outside / "keep.txt"
        sentinel.write_text("keep", encoding="utf-8")
        (project_dir / ".agile" / "workflows" / "test-wf").symlink_to(
        ...
        assert result.exit_code != 0
        assert "symlinked .agile/workflows/test-wf" in result.output
        assert sentinel.read_text(encoding="utf-8") == "keep"
    ...
    def test_remove_refuses_non_directory_workflow_path(self, project_dir, monkeypatch):
        ...
        registry = WorkflowRegistry(project_dir)
        registry.add("test-wf", {"name": "Test"})
        workflow_path = project_dir / ".agile" / "workflows" / "test-wf"
    ...
    def test_remove_registry_save_failure_preserves_files_and_registry(
        ...
        registry = WorkflowRegistry(project_dir)
        registry.add("test-wf", {"name": "Test", "version": "1.0.0"})
        workflow_dir = project_dir / ".agile" / "workflows" / "test-wf"
        ...
        entries = [
            p.name
            for p in (project_dir / ".agile" / "workflows").iterdir()
    ...
    def test_remove_staged_cleanup_failure_reports_warning_not_error(
        ...
        .agile/workflows/<id>) *before* the registry write, and the actual
    ...
    def test_remove_stage_restore_failure_escapes_rich_markup(
        ...
        (project_dir / ".agile" / "workflows").mkdir()
...
class TestWorkflowAddCaseInsensitiveSuffix:
    ...
    def test_plain_path_accepts_uppercase_extension(self, temp_dir, monkeypatch, sample_workflow_yaml):
        ...
        (temp_dir / ".agile" / "workflows").mkdir(parents=True)
...
class TestWorkflowInfoStepGraph:
    ...
    def test_catalog_metadata_fields_escaped(self, temp_dir, monkeypatch):
        ...
        from agile_cli import app
        from agile_cli.workflows.engine import WorkflowEngine
        from agile_cli.workflows import catalog as catalog_mod
...
class TestWorkflowAddSymlinkGuard:
    def test_add_malformed_ipv6_url_exits_cleanly(self, temp_dir, monkeypatch):
        ...
        (temp_dir / ".agile").mkdir(exist_ok=True)
        monkeypatch.chdir(temp_dir)
    ...
    def test_add_refuses_symlinked_specify(self, temp_dir, monkeypatch):
        """workflow add must refuse a symlinked .agile (writes could escape root)."""
        from typer.testing import CliRunner
        from agile_cli import app

        outside = temp_dir.parent / "outside-specify-target"
        (outside / "workflows").mkdir(parents=True, exist_ok=True)
        (temp_dir / ".agile").symlink_to(outside, target_is_directory=True)

        monkeypatch.chdir(temp_dir)
        result = CliRunner().invoke(app, ["workflow", "add", "anything.yml"])

        assert result.exit_code != 0
        assert "symlinked .agile" in result.output

    @pytest.mark.skipif(not hasattr(os, "symlink"), reason="symlinks are unavailable")
    def test_add_refuses_symlinked_workflows_dir(self, temp_dir, monkeypatch):
        """workflow add must refuse a symlinked .agile/workflows directory."""
        from typer.testing import CliRunner
        from agile_cli import app

        (temp_dir / ".agile").mkdir()
        outside = temp_dir.parent / "outside-workflows-target"
        outside.mkdir(parents=True, exist_ok=True)
        (temp_dir / ".agile" / "workflows").symlink_to(outside, target_is_directory=True)

        monkeypatch.chdir(temp_dir)
        result = CliRunner().invoke(app, ["workflow", "add", "anything.yml"])

        assert result.exit_code != 0
        assert "symlinked .agile/workflows" in result.output
...
""",
    ...
    def test_add_refuses_symlinked_id_dir(self, temp_dir, monkeypatch, sample_workflow_yaml):
        ...
        (temp_dir / ".agile" / "workflows" / "test-workflow").symlink_to(
            outside, target_is_directory=True
        )
        src = temp_dir / "incoming.yml"
        src.write_text(sample_workflow_yaml, encoding="utf-8")
    ...
    def test_add_refuses_symlinked_workflow_yml_leaf(self, temp_dir, monkeypatch, sample_workflow_yaml):
        ...
        id_dir = temp_dir / ".agile" / "workflows" / "test-workflow"
    ...
    def test_add_refuses_non_directory_id(self, temp_dir, monkeypatch, sample_workflow_yaml):
        ...
        wf_dir = temp_dir / ".agile" / "workflows"
        wf_dir.mkdir(parents=True)
    ...
    def test_safe_workflow_id_dir_escapes_markup_in_invalid_id(self, temp_dir, capsys):
        ...
        import typer
        from agile_cli.workflows._commands import _safe_workflow_id_dir

        workflows_dir = temp_dir / ".agile" / "workflows"
...
""".strip()
        ...
        assert result.exit_code != 0
        assert "Invalid workflow ID" in result.output
        assert not (temp_dir / ".agile" / "workflows" / "overlays" / "workflow.yml").exists()
    ...
    def test_list_refuses_symlinked_runs_dir(self, temp_dir, monkeypatch):
        ...
        outside.mkdir(parents=True, exist_ok=True)
        (temp_dir / ".agile" / "workflows" / "runs").symlink_to(
            outside, target_is_directory=True
        )
        ...
        assert result.exit_code != 0
        assert "symlinked .agile/workflows/runs" in result.output
...
class TestWorkflowStepRichMarkup:
    ...
    def test_info_escapes_catalog_metadata(
        ...
        from typer.testing import CliRunner
        from agile_cli import app
        from agile_cli.workflows.catalog import StepCatalog, StepRegistry
...
class TestWorkflowStepAddCLI:
    ...
    def test_add_rejects_oversized_step_response(self, project_dir, monkeypatch):
        from typer.testing import CliRunner
        from agile_cli import app
        from agile_cli.workflows import _commands as wf_commands
        from agile_cli.workflows.catalog import StepCatalog
        from agile_cli.authentication import http as auth_http
        ...
        assert not (
            project_dir / ".agile" / "workflows" / "steps" / "my-step"
        ).exists()
    ...
    def test_add_rejects_too_many_package_files_before_network(
        ...
        from agile_cli import app
        from agile_cli.authentication import http as auth_http
        from agile_cli.workflows import _commands as workflow_commands
        from agile_cli.workflows.catalog import StepCatalog
        ...
        steps_dir = project_dir / ".agile" / "workflows" / "steps"
        assert not (steps_dir / "my-step").exists()
        assert list(steps_dir.glob("agile_step_tmp_*")) == []
...
"""
    ...
    def test_json_redirect_keeps_stdout_clean(self, capfd):
        ...
        import subprocess
        import sys as _sys
        from agile_cli.workflows._commands import _stdout_to_stderr_when
...
"""
    ...
    def test_resume_merges_and_coerces_typed_input(self, project_dir):
        ...
        inputs_file = (
            project_dir / ".agile" / "workflows" / "runs" / state.run_id / "inputs.json"
        )
    ...
    def test_resume_rejects_legacy_invalid_options_before_state_mutation(
        ...
        from agile_cli.workflows.base import RunStatus
        from agile_cli.workflows.engine import RunState, WorkflowDefinition
        ...
        monkeypatch.setattr("agile_cli.workflows.engine.StepContext", fail_step_context)
...
"""
        ...
        with patch.object(Path, "cwd", return_value=project_dir), \
             patch("agile_cli.authentication.http.open_url", side_effect=fake_open_url), \
             patch("agile_cli.workflows.catalog.WorkflowCatalog.get_workflow_info", return_value=fake_catalog_info):
...
"""
    ...
    def test_resume_failed_run_exits_nonzero(self, tmp_path, monkeypatch):
        ...
        monkeypatch.chdir(tmp_path)
        (tmp_path / ".agile").mkdir()  # `workflow resume` requires a project
        runner = CliRunner()
        run = runner.invoke(
            app,
            ["workflow", "run", str(self._write(tmp_path, self._WF_FAIL)), "--json"],
...
"""
    ...
    def test_gate_block_emitted_only_when_run_rests_at_gate(self):
        ...
        from agile_cli.workflows._commands import _gate_outcome
...
"""
    ...
    def test_add_local_directory_preserves_package_files(
        ...
        assert result.exit_code == 0, result.output
        installed = project_dir / ".agile" / "workflows" / "align-wf"
    ...
    def test_add_from_rejects_invalid_source_id_without_fetch(self, project_dir, monkeypatch):
        ...
        runner = CliRunner()
        with patch("agile_cli.authentication.http.open_url", side_effect=_fake_open):
    ...
    def test_update_skip_message_accurate_for_bundled_source(self, project_dir, monkeypatch):
        """A workflow registered with source "bundled" (e.g. the agile
        workflow installed by `agile init`) was never installed from a
        ...
        registry.add(
            "agile",
            {"name": "Agile", "version": "1.0.0", "source": "bundled"},
        )
        runner = CliRunner()
        result = runner.invoke(app, ["workflow", "update"])
        assert result.exit_code == 0, result.output
    ...
    def test_registry_save_refuses_symlinked_parent(self, project_dir, tmp_path):
        """Construction now fails closed on a symlinked .agile just like
    ...
    def test_add_save_failure_leaves_no_orphan_directory(self, project_dir, monkeypatch, mode):
        ...
        assert result.exception is None or isinstance(result.exception, SystemExit)
        assert result.output.strip() != ""
        dest_dir = project_dir / ".agile" / "workflows" / "align-wf"
    ...
    def test_add_non_json_description_rolls_back_transaction(
        ...
        from typer.testing import CliRunner
        from agile_cli import app
        from agile_cli.workflows.catalog import WorkflowCatalog, WorkflowRegistry
    ...
    def test_add_reinstall_mkstemp_failure_preserves_preexisting_directory(
        ...
        runner = CliRunner()
        src = self._install_dev(runner, app, project_dir)
        installed_yaml = project_dir / ".agile" / "workflows" / "align-wf" / "workflow.yml"
    ...
    def test_stage_write_rejects_swapped_symlink(
        ...
        from typer.testing import CliRunner
        from agile_cli import app
        from agile_cli.workflows import _commands
        from agile_cli.workflows.catalog import WorkflowCatalog
    ...
    def test_add_dev_successful_reinstall_leaves_no_backup_file(
        ...
        runner = CliRunner()
        src = self._install_dev(runner, app, project_dir)
        workflow_dir = project_dir / ".agile" / "workflows" / "align-wf"
    ...
    def test_add_catalog_reinstall_save_failure_restores_prior_file(self, project_dir, monkeypatch):
        ...
        dest_file = project_dir / ".agile" / "workflows" / "align-wf" / "workflow.yml"
    ...
    def test_concurrent_catalog_reinstalls_keep_file_and_registry_aligned(
        ...
        workflows_dir = project_dir / ".agile" / "workflows"
    ...
    def test_precommit_discard_preserves_concurrent_install(self, project_dir):
        ...
        workflow_dir = (
            project_dir / ".agile" / "workflows" / "concurrent-wf"
        )
    ...
    def test_add_dev_registry_reopen_exit_discards_staged_file(
        ...
        assert result.exit_code != 0
        assert not (
            project_dir / ".agile" / "workflows" / "align-wf"
        ).exists()
    ...
    def test_add_catalog_reinstall_early_failure_restores_prior_file(
        ...
        with pytest.MonkeyPatch.context() as mp:
            mp.setattr("agile_cli.authentication.http.open_url", fake_open_url)
            result = runner.invoke(app, ["workflow", "add", "align-wf"])
    ...
    def test_download_redirect_validator_rejects_http_before_follow(self):
        ...
        from agile_cli.workflows._commands import _reject_insecure_download_redirect
    ...
    def test_add_from_url_passes_redirect_validator(self, project_dir, monkeypatch):
        ...
        runner = CliRunner()
        with patch("agile_cli.authentication.http.open_url", side_effect=fake_open):
            result = runner.invoke(
                app,
                ["workflow", "add", "align-wf", "--from", "https://example.com/workflow.yml"],
                input="y\n",
    ...
    def test_update_installs_newer_catalog_version(self, project_dir, monkeypatch):
        ...
        wf_dir = project_dir / ".agile" / "workflows" / "align-wf"
        wf_dir.mkdir(parents=True)
        (wf_dir / "workflow.yml").write_text(
            self.WORKFLOW_YAML.format(version="1.0.0"), encoding="utf-8"
        )
    ...
    def test_update_reports_unsafe_registry_id_per_workflow(self, project_dir, monkeypatch):
        ...
        from typer.testing import CliRunner
        from agile_cli import app
        from agile_cli.workflows.catalog import WorkflowRegistry, WorkflowCatalog
    ...
    def test_update_restores_backup_on_failed_download(self, project_dir, monkeypatch):
        ...
        runner = CliRunner()
        with patch("agile_cli.authentication.http.open_url", side_effect=boom):
            result = runner.invoke(app, ["workflow", "update"], input="y\n")
        assert result.exit_code != 0
        assert "Failed to update" in result.output
    ...
    def test_disable_blocks_run_via_path_equivalent_id(self, project_dir, monkeypatch):
        ...
        installed_yaml = ".agile/workflows/align-wf/workflow.yml"
    ...
    def test_disable_blocks_run_when_installed_yaml_is_symlinked(
        ...
        .agile/workflows, fail to find an owner, and let engine.load_workflow
    ...
    def test_run_refuses_symlinked_specify_dir_hiding_disabled_workflow(
        ...
        """A victim project's own .agile directory being a symlink to an
        ...
        components from the id directory onward, missing .agile/
        .agile/workflows themselves. The ownership check must reject an
        unsafe .agile/.agile-workflows for the actual path-derived
        ...
        (victim / ".agile").symlink_to(attacker_real)
        ...
        runner = CliRunner()
        target = victim / ".agile" / "workflows" / "evil" / "workflow.yml"
    ...
    def test_run_nested_installed_paths_uses_nearest_owner(
        ...
        .agile/workflows more than once (an unrelated nested project
        ...
        outer_workflows = temp_dir / "outer-proj" / ".agile" / "workflows"
        ...
        inner_workflows = outer_wf_dir / "nested-proj" / ".agile" / "workflows"
    ...
    def test_run_blocks_disabled_workflow_via_outward_alias_symlink(
        ...
        .agile/workflows segments at all (e.g. /tmp/alias.yml) that is
        ...
        installed_yaml = (
            project_dir / ".agile" / "workflows" / "align-wf" / "workflow.yml"
        )
...
"""
    ...
    def test_unregistered_workflow_shaped_path_is_not_persisted_as_owner(
        ...
        workflows_dir = standalone_root / ".agile" / "workflows"
    ...
    def test_resume_preload_rejects_malformed_state_cleanly(
        ...
        run_id = self._install_and_run_gated(runner, app, project_dir)
        state_path = (
            project_dir / ".agile" / "workflows" / "runs" / run_id / "state.json"
        )
    ...
    def test_resume_blocks_after_project_moved_following_disable(
        ...
        (project_v1 / ".agile" / "workflows").mkdir(parents=True)
    ...
    def test_resume_respects_cross_project_registry_root(
        ...
        (owner_project / ".agile" / "workflows").mkdir(parents=True)
        ...
        target = owner_alias / ".agile" / "workflows" / "gated-wf" / "workflow.yml"
    ...
    def test_resume_rejects_missing_cross_project_owner_root(
        ...
        target = owner_project / ".agile" / "workflows" / "gated-wf" / "workflow.yml"
        result = runner.invoke(app, ["workflow", "run", str(target), "--json"])
        assert result.exit_code == 0, result.output
        run_id = json.loads(result.stdout)["run_id"]
    ...
    def test_status_run_not_found_unchanged(self, project_dir, monkeypatch):
        ...
        monkeypatch.chdir(project_dir)
        (project_dir / ".agile" / "workflows").mkdir(parents=True, exist_ok=True)
        runner = CliRunner()
    ...
    def test_status_unreadable_run_state_exits_cleanly(
        ...
        monkeypatch.chdir(project_dir)
        runs_dir = project_dir / ".agile" / "workflows" / "runs" / "abc123"
        runs_dir.mkdir(parents=True, exist_ok=True)
