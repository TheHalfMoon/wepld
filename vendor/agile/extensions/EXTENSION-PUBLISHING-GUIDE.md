...
This guide explains how to publish your extension to the Agile extension catalog, making it discoverable by `agile extension search`.
...
extension:
  ...
  repository: "https://github.com/your-org/agile-your-extension"
  license: "MIT"
  homepage: "https://github.com/your-org/agile-your-extension"

requires:
  agile_version: ">=0.1.0"    # Required agile version

provides:
  commands:                       # List all commands
    - name: "agile.your-extension.command"
...
# Go to: https://github.com/your-org/agile-your-extension/releases/new
# - Tag: v1.0.0
...
```text
https://github.com/your-org/agile-your-extension/archive/refs/tags/v1.0.0.zip
```
...
agile extension add --dev /path/to/your-extension

# Test from GitHub archive
agile extension add <extension-name> --from https://github.com/your-org/agile-your-extension/archive/refs/tags/v1.0.0.zip
```
...
Agile uses a dual-catalog system. For details about how catalogs work, see the main [Extensions README](README.md#extension-catalogs).
...
To submit your extension to the community catalog, file a new issue using the **[Extension Submission](https://github.com/TheHalfMoon/wepld/issues/new?template=extension_submission.yml)** template. The template collects all required metadata, including:

- Extension ID, name, and version
- Description, author, and license
- Repository, download URL, and documentation links
- Required Agile version and any tool dependencies
...
4. Your extension becomes discoverable via `agile extension search`
...
4. **File an update submission** using the [Extension Submission](https://github.com/TheHalfMoon/wepld/issues/new?template=extension_submission.yml) template with the new version and download URL. Mention in the issue that this is an update to an existing entry.
...
- Users add your catalog: `agile extension add-catalog https://your-domain.com/catalog.json`
...
A: Yes, file a new [Extension Submission](https://github.com/TheHalfMoon/wepld/issues/new?template=extension_submission.yml) issue with the updated version and download URL. Mention that it is an update to an existing entry.
...
- **Catalog Issues**: <https://github.com/statsperform/agile/issues>
- **Extension Template**: <https://github.com/statsperform/agile-extension-template> (coming soon)
...
```json
{
  ...
  "requires": {
    "agile_version": "string (required, version specifier)",
    "tools": [
      {
        "name": "string (required)",
