...
function printUsage() {
  console.log(`Usage: pictorial detect [options] [file-or-dir-or-url...]
...
Options:
  ...
  --no-inline-ignores Do not honor in-file pictorial-disable* ignore comments
  --no-design-system  Do not load local DESIGN.md / .pictorial/design.json context
...
Project config:
  Respects .pictorial/config.json and .pictorial/config.local.json detector
  settings: detector.ignoreRules, detector.ignoreFiles, detector.ignoreValues,
  and detector.designSystem.enabled.

Inline ignores:
  In-file comments waive a finding where it lives and travel with the file:
    <!-- pictorial-disable overused-font -- exported brand doc -->
    .brand { font-family: Inter } /* pictorial-disable-line overused-font */
    // pictorial-disable-next-line bounce-easing: intentional bounce
  pictorial-disable applies to the whole file; -line / -next-line are scoped.
...
Examples:
  pictorial detect src/
  pictorial detect index.html
  pictorial detect https://example.com
  pictorial detect --json .
  pictorial detect --no-config src/`);
}
...
async function detectCli() {
  ...
  // Inline `pictorial-disable*` waivers are part of the scanned file, so they
