 ...
 * session's `pictorial-variants-start` marker). They had two near-identical
...
import { PICTORIAL_DIR } from '../lib/pictorial-paths.mjs';
 ...
 *
 * `.pictorial` is the critical entry, and it is not cosmetic. Progressive
 * publication stages each revision as `.pictorial/live/artifacts/
 ...
 * hand.
 */
export const NEVER_SOURCE_DIRS = Object.freeze(['node_modules', '.git', PICTORIAL_DIR]);
