...
ZCode uses the ``.zcode/skills/agile-<name>/SKILL.md`` layout, matching
the Claude Code skill format. Skills are invoked in chat with
``$agile-<name>``. Z.AI recommends skills (over simple ``/`` commands)
for template- and script-driven workflows such as agile.
"""
