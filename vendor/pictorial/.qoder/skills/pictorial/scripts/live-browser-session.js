...
/**
 * Browser-side durable session helpers for Pictorial live mode.
 *
 ...
 * window.__PICTORIAL_LIVE_SESSION__.
 */
(function (root) {
  'use strict';
  ...
  root.__PICTORIAL_LIVE_SESSION__ = { createLiveBrowserSessionState };
