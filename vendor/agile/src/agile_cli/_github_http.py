...
through the config-driven helpers in :mod:`agile_cli.authentication.http`.
"""
...
def resolve_github_release_asset_api_url(
    ...
    Args:
        ...
        open_url_fn: A callable compatible with
            ``agile_cli.authentication.http.open_url`` used for the
    ...
    from agile_cli._download_security import read_response_limited
