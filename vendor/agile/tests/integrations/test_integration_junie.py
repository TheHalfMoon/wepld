...
from agile_cli.integrations.junie import format_junie_command_name
...
class TestJunieCommandNameFormatter:
    ...
    def test_simple_name_without_prefix(self):
        ...
        assert format_junie_command_name("plan") == "agile-plan"
        assert format_junie_command_name("tasks") == "agile-tasks"
        assert format_junie_command_name("agile") == "agile-specify"

    def test_name_with_agile_prefix(self):
        """Test formatting a name that already has 'agile.' prefix."""
        assert format_junie_command_name("agile.plan") == "agile-plan"
        assert format_junie_command_name("agile.tasks") == "agile-tasks"

    def test_extension_command_name(self):
        """Test formatting extension command names with dots."""
        assert (
            format_junie_command_name("agile.my-extension.example")
...
class TestJunieIntegration(MarkdownIntegrationTests):
    ...
    def test_junie_handoff_rewrite(self):
        """Verify junie rewrites agent: agile.foo to agent: agile-foo."""
        junie = get_integration("junie")
        content = "---\nagent: agile.plan\n---\n"
