"""Bundle path resolution and version lookup for agile_cli.
...
def _locate_core_pack() -> Path | None:
    ...
    templates/, scripts/ etc. into agile_cli/core_pack/ at build time.
...
def get_agile_version() -> str:
    """Get current agile version."""
    try:
