...
Read this when the user invokes `{{command_prefix}}pictorial` with no argument. They are asking "what should I do?" Make the menu context-aware instead of static.
