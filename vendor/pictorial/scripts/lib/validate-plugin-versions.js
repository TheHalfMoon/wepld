 ...
 *   - `plugin/skills/pictorial/SKILL.md` frontmatter version — generated;
 *     same rationale.
 *   - `dist/openai/pictorial/.codex-plugin/plugin.json` version — generated
...
export function collectPluginVersions(rootDir) {
  ...
  const checks = [
    ...
    {
      relPath: 'dist/openai/pictorial/.codex-plugin/plugin.json',
      read: (raw) => JSON.parse(raw).version,
    },
    {
      relPath: 'plugin/skills/pictorial/SKILL.md',
