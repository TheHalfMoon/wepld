"""Regression guard: console symbols must remain importable from agile_cli."""
import logging
...
from agile_cli._console import logger as console_logger
...
def test_console_symbols_available_from_star_import():
    namespace = {}
    exec("from agile_cli import *", namespace)
...
def test_select_with_arrows_fails_fast_when_stdin_is_not_a_tty(monkeypatch, capsys):
    ...
    monkeypatch.setattr("agile_cli._console.readchar.readkey", fail_readkey)
