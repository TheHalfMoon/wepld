...
2. **Check checklists status** (if FEATURE_DIR/checklists/ exists):
   ...
   - `checklists/requirements.md` is the built-in spec-quality checklist maintained by `__AGILE_COMMAND_AGILE__` and `__AGILE_COMMAND_CLARIFY__`; custom checklists generated by `__AGILE_COMMAND_CHECKLIST__` are reviewer-owned requirements-quality review artifacts
