...
POST_V1_5_TOP_LEVEL_ENTRIES = 5
CURRENT_ACCOUNTED_ENTRIES = 402
...
`wepld/wepld` is a historical quarry only. Its old main, PR #1, and PR #11 may provide exact concepts/tests/failure corpora only after salvage/acquisition review.
