...
- **Suggested command**: Which command to use (prefer: $pictorial adapt, $pictorial animate, $pictorial audit, $pictorial bolder, $pictorial clarify, $pictorial colorize, $pictorial critique, $pictorial delight, $pictorial distill, $pictorial document, $pictorial harden, $pictorial layout, $pictorial onboard, $pictorial optimize, $pictorial overdrive, $pictorial polish, $pictorial quieter, $pictorial shape, $pictorial typeset)
