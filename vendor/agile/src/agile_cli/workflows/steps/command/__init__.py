"""Command step — dispatches a Agile command to an integration CLI."""
...
class CommandStep(StepBase):
    """Default step type — invokes a Agile command via the integration CLI.
    ...
    .. note::
        ...
        by later steps (e.g. ``{{ steps.agile.output.exit_code }}``).
