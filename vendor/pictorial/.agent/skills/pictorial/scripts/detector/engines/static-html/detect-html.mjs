...
async function detectHtml(filePath, options = {}) {
  ...
  if (!globalThis.__pictorialStaticHtmlWarned) {
    globalThis.__pictorialStaticHtmlWarned = true;

    process.stderr.write(
  'pictorial detect: DEGRADED - HTML parser modules unavailable ' +
  ...
  // `pictorial-disable` directives apply here — exactly the standalone-document
