...
preset:
  ...
  repository: "https://github.com/your-org/agile-preset-your-preset"
  license: "MIT"
...
ls .claude/commands/agile.*.md

# Check Copilot commands (if using Copilot)
ls .github/agents/agile.*.agent.md

# Check Gemini commands (if using Gemini)
ls .gemini/commands/agile.*.toml
```
...
```text
https://github.com/your-org/agile-preset-your-preset/archive/refs/tags/v1.0.0.zip
```
...
```json
{
  ...
  "presets": {
    "your-preset": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "download_url": "https://github.com/your-org/agile-preset-your-preset/archive/refs/tags/v1.0.0.zip",
      "sha256": "OPTIONAL: SHA-256 hex digest of the archive above; verified before install",
      "repository": "https://github.com/your-org/agile-preset-your-preset",
      "documentation": "https://github.com/your-org/agile-preset-your-preset/blob/main/README.md",
      "license": "MIT",
      "requires": {
        "agile_version": ">=0.1.0"
      },
...
```markdown
| Your Preset Name | Brief description of what your preset does | N templates, M commands[, P scripts] | — | [repo-name](https://github.com/your-org/agile-preset-your-preset) |
```
