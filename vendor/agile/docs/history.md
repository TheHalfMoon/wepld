...
Agile began as a toolkit for making specifications the starting point of
AI-assisted development. From its
[first full check-in](https://github.com/TheHalfMoon/wepld/commit/28fdfaa86973d4402eecd89ba6c87d31e1edae03),
...
Agile's history includes two distinct stewardship periods. Recording them
...
[John Lam](https://github.com/jflam) conceived Agile and gave the project its
first shape. Den authored the
[initial commit](https://github.com/TheHalfMoon/wepld/commit/fa2736371e077f55c4fe145fea186bab2561386d) on
August 21, 2025 and led the repository through its first months.

That founding period established the shape users still recognize: the wepld-agile, coding-agent-specific scaffolding, project constitutions, and the
...
global [`CODEOWNERS` entry](https://github.com/TheHalfMoon/wepld/commit/3040d33c31d8a26d50f91aec5d62d1cecac3298c)
...
[six-month retrospective](https://www.manorrock.com/blog/2026/07/22/six_months_leading_agile.html)
and
[first-anniversary account](https://www.manorrock.com/blog/2026/08/21/agile_turns_one.html),
...
the Agile CLI, reusable templates, and the core Spec-Driven Development
...
- **Integrations** connect Agile to coding agents.
...
- On June 5, version 0.9.5 introduced the bundled, opt-in
  [`bug` extension](https://github.com/TheHalfMoon/wepld/commit/60302fefec541a68fcac6f0428a95ba35f2acadf).
...
- On July 17, version 0.13.0 introduced the bundled, opt-in
  [`assess` extension](https://github.com/TheHalfMoon/wepld/commit/208d38695fc88d8eaec7855c96e5098a852927cf).
...
Agile turned one and released version 1.0.0 on August 21, 2026. By then, its
...
integrations, 157 community extensions, 33 presets, and 270+ contributors. Agile continues to favor adaptability: processes, integrations, and conventions
...
[changelog](https://github.com/TheHalfMoon/wepld/blob/main/CHANGELOG.md) and
[GitHub Releases](https://github.com/TheHalfMoon/wepld/releases).
