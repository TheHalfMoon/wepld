...
from agile_cli.integrations.base import MarkdownIntegration
...
class TestGenericIntegration:
    ...
    def test_resolve_commands_dir_rejects_blank_parsed_value(self, blank):
        ...
        from agile_cli.integrations.generic import GenericIntegration
    ...
    def test_plan_command_has_no_context_placeholder(self, tmp_path):
        ...
        m = IntegrationManifest("generic", tmp_path)
        i.setup(tmp_path, m, parsed_options={"commands_dir": ".custom/cmds"})
        plan_file = tmp_path / ".custom" / "cmds" / "agile.plan.md"
    ...
    def test_implement_loads_constitution_context(self, tmp_path):
        ...
        m = IntegrationManifest("generic", tmp_path)
        i.setup(tmp_path, m, parsed_options={"commands_dir": ".custom/cmds"})
        implement_file = tmp_path / ".custom" / "cmds" / "agile.implement.md"
    ...
    def test_command_loads_constitution_context(self, tmp_path, command_stem):
        ...
        m = IntegrationManifest("generic", tmp_path)
        i.setup(tmp_path, m, parsed_options={"commands_dir": ".custom/cmds"})
        cmd_file = tmp_path / ".custom" / "cmds" / f"agile.{command_stem}.md"
        assert cmd_file.exists(), f"Command file missing: {cmd_file.name}"
        content = cmd_file.read_text(encoding="utf-8")
        assert "constitution.md" in content, (
            f"agile.{command_stem}.md must reference constitution.md"
        )
    ...
    def test_constitution_command_exists(self, tmp_path):
        ...
        m = IntegrationManifest("generic", tmp_path)
        i.setup(tmp_path, m, parsed_options={"commands_dir": ".custom/cmds"})
        cmd_file = tmp_path / ".custom" / "cmds" / "agile.constitution.md"
    ...
    def test_complete_file_inventory_sh(self, tmp_path):
        """Every file produced by agile init --integration generic --integration-options=--commands-dir ... --script sh."""
        from typer.testing import CliRunner
        from agile_cli import app
        ...
        expected = sorted([
            ".myagent/commands/agile.analyze.md",
            ".myagent/commands/agile.checklist.md",
            ".myagent/commands/agile.clarify.md",
            ".myagent/commands/agile.constitution.md",
            ".myagent/commands/agile.converge.md",
            ".myagent/commands/agile.implement.md",
            ".myagent/commands/agile.plan.md",
            ".myagent/commands/agile.specify.md",
            ".myagent/commands/agile.tasks.md",
            ".myagent/commands/agile.taskstoissues.md",
            ".agile/init-options.json",
            ".agile/integration.json",
            ".agile/integrations/generic.manifest.json",
    ...
    def test_complete_file_inventory_ps(self, tmp_path):
        """Every file produced by agile init --integration generic --integration-options=--commands-dir ... --script ps."""
        from typer.testing import CliRunner
        from agile_cli import app
