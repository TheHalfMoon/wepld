...
/**
 * Context-signals gatherer for the bare Pictorial invocation
 ...
 * light: no LLM calls, no detector run (`npx @wepld/pictorial detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.pictorial/critique)
...
// .pictorial/, issue #303), a build artifact, or a dependency. Mirrors the
