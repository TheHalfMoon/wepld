...
def _resolve_workflows_root(project_root: Path) -> Path:
    ...
    workflows_root = project_root / ".agile" / "workflows"
...
class ProjectOverlaySource:
    """Project-local overlays: ``.agile/workflows/overlays/<id>/*.yml``."""

    tier = "project-overlay"

    def __init__(self, project_root: Path) -> None:
        self.project_root = project_root
        self.overlays_dir = project_root / ".agile" / "workflows" / "overlays"
...
class BaseWorkflowSource:
    """Base workflow layer: ``.agile/workflows/<id>/workflow.yml``."""
