...
class RovodevIntegration(SkillsIntegration):
    ...
    Uses the skills layout (``agile-<name>/SKILL.md``) and adds
    ...
    def _resolve_executable(self) -> str:
        ...
        standard ``AGILE_INTEGRATION_ROVODEV_EXECUTABLE`` env-var override.
        """
        env_name = (
    ...
    def build_exec_args(
        ...
        *,
        ...
        Honours the standard env-var contract:
          - ``AGILE_INTEGRATION_ROVODEV_EXECUTABLE`` overrides ``acli``
    ...
    def _generate_prompt_files(
        ...
        (e.g. ``.rovodev/skills/agile-plan/SKILL.md`` → ``agile-plan``).
