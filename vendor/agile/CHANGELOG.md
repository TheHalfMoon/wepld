...
- docs: use Agile branding on documentation site (#4264)
- docs: add existing project adoption guide (#4263)
- docs: add project history page (#4262)
- docs: mark Agile's first anniversary (#4260)
...
- Update Agile Companion extension to v0.20.2 (#4225)
...
- fix: provision Agile CLI and assess extension in feature-assess host setup steps (#4195)
- fix: provision uv and Python for feature-assess workflow (#4193)
- feat: add feature-assess agentic workflow that installs and runs Agile (#4186)
- [extension] Update Superpowers Implementation Bridge to v1.2.0 (#4183)
- fix(init): stop agile init hanging on arrow-key pickers in agent harnesses (#4178)
...
- [extension] Add agile-atlas extension to community catalog (#4105)
...
- Add Agile Grill Me extension to community catalog (#4052)
...
- Add Command Code integration to agile (#4019)
...
- docs: document installing wepld-agile from a custom package index (#4032)
...
- fix(init): escape user-supplied values in `agile init` output (#3787)
...
- feat(init): scaffold managed .agile/.gitignore (#4000)
...
- fix(manifests): reject non-string requires.agile_version (#3980)
...
- feat: allow overriding default init integration via AGILE_INTEGRATION_DEFAULT (#3952)
...
- Add `--extension` flag to `agile init` for opting into extensions at init time (#3914)
...
- fix(integrations): render hyphenated /agile-<name> for Droid (always-slash agent) (#3688)
...
- docs: add agile-copilot to community friends (#3675)
...
- fix(init): show hyphenated /agile-<name> in Next Steps for Forge projects (#3642)
...
- fix(integrations): Cline dispatches hyphenated /agile-<cmd> invocations (#3622)
...
- docs: document __AGILE_COMMAND_ token for portable cross-command references (#3503)
...
- fix(integrations): Forge dispatches hyphenated /agile-<cmd> invocations (#3529)
...
- fix(extensions): resolve __AGILE_COMMAND tokens in auto-registered skills (#3544)
...
- [extension] Add Agile BDD extension to community catalog (#3548)
...
- [extension] Add Agile Memory extension to community catalog (#3455)
...
- Add Agile Figma extension to community catalog (#3408)
...
- fix(integrations): agy honors AGILE_INTEGRATION_AGY_EXTRA_ARGS (#3347)
...
- fix(integrations): hermes honors AGILE_INTEGRATION_HERMES_EXTRA_ARGS (#3346)
...
- fix: allow prerelease agile versions in compatibility checks (#2695)
...
- docs: remove Cursor from `agile check` agent list (#3178) (#3193)
...
- Docs: Document /agile.converge command (#3181)
...
- fix(claude): stop forking /agile-analyze to prevent long-session freezes (#3188)
...
- docs: add Agile Assistant npm package to Community Friends (#3142)
- Require preset-usage README with Agile CLI syntax in preset submissions (#3104)
...
- docs: run /agile.checklist after /agile.plan in quickstart (#3108)
...
- [extension] Update Agile Preview extension to v1.1.0 and sync Firebender agent lists (#3116)
- Add Agile Discovery Extension to community catalog (#3119)
...
- fix(build): include agile_cli.bundler.lib in built distribution (#3085)
...
- feat: add `agile bundle` command (#3070)
...
- feat: add /agile.converge command (#3001)
...
- Add `init` workflow step to bootstrap projects like `agile init` (#2838)
...
- Add Agile TLDR extension to community catalog (#3007)
...
- Add Agile Companion extension to community catalog (#2937)
...
- chore(catalog): bump Linear Integration to v0.3.0 (repo renamed to agile-linear-sync) (#2893)
...
- fix(shared-infra): record skipped files in agile.manifest.json (#2483)
...
- Add agile-linear extension to community catalog (#2795)
...
- Add Multi-Sites Agile extension to community catalog (#2791)
...
- Add support for AGILE_WORKFLOW_RUN_ID override (#2742)
- feat: support AGILE_INTEGRATION_<KEY>_EXECUTABLE env var (#2743)
...
- fix: resolve __AGILE_COMMAND_*__ refs in preset skill rendering (#2717) (#2718)
...
- fix init-options agile version refresh (#2647)
...
- feat(catalog): add Agile Schedule (schedule) community extension (#2473)
...
- Load constitution context in `/agile.implement` to enforce governance during implementation (#2460)
...
- feat: Agile preset fiction book v1.7 - Support for RAG (Chroma DB) offline semantic search (#2367)
...
- fix(plan): use .agile/feature.json to allow /agile.plan on custom git branches (#2305) (#2349)
...
- docs: add Community-maintained plugin for Claude Code and GitHub Copilot CLI that installs Agile skills via the plugin marketplace to README (#2250)
...
- chore: deprecate --ai flag in favor of --integration on agile init (#2218)
...
- Add SFAgile — Salesforce SDD Extension (#2208)
...
- chore: bump agile-verify to 1.0.3 and agile-review to 1.0.1 (#2146)
...
- docs: add Agile Companion to Community Friends section (#2140)
...
- feat: add agile-fixit extension to community catalog (#2024)
...
- feat: add agile-onboard extension to community catalog (#1991)
...
- docs: add Community Friends section with Agile Assistant VS Code extension (#1944)
...
- fix(scripts): prioritize .agile over git for repo root detection (#1933)
...
- feat: add timestamp-based branch naming option for `agile init` (#1911)
...
- docs(catalog): add agile-utils to community catalog (#1896)
...
- feat: register agile-iterate extension (#1887)
...
- Feature/agile add pi coding agent pullrequest (#1853)
- feat: register agile-learn extension (#1883)
...
- fix(ai-skills): exclude non-agile copilot agent markdown from skills (#1867)
...
- Add agile doctor command for project health diagnostics (#1828)
...
- Integration of Mistral vibe support into agile (#1725)
...
- docs: Add comprehensive upgrading guide for Agile
...
- Update scripts/powershell/create-new-feature.ps1
- Update src/agile_cli/__init__.py
...
- fix: correct command references in agile.analyze.md
...
- chore: add `agile`'s github copilot chat settings to `devcontainer`
...
- docs(readme): add /agile.tasks step and renumber walkthrough
...
- Update changelog
- Update plan.md
- Add ignore file verification step to /agile.implement command
...
- Update __init__.py
- Update src/agile_cli/__init__.py
- docs: fix the paths of generated files (moved under a `.agile/` folder)
- Update src/agile_cli/__init__.py
- feat: support 'agile init .' for current directory initialization
...
- feat: add Qwen Code support to Agile
