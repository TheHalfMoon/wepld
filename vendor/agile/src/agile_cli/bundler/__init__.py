"""Agile bundler — importable, Typer-free logic for the ``agile bundle`` group.

This package holds the models, services, and helpers behind the ``agile bundle``
...
Principle I). The CLI wiring lives in ``agile_cli.commands.bundle``.
"""
