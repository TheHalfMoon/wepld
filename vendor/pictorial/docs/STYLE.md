...
Editorial brief for pictorial.design. Read this before writing or editing user-facing copy: the homepage, sub-pages, command editorials, tutorials, and READMEs.
...
- **Interchangeable copy.** Swap "Pictorial" for a competitor name. If nothing becomes false, the copy is generic.
