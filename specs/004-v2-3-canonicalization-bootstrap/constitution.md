...
3. Qualify, independently review, merge, and prove canonical activation of that bootstrap policy.
4. Create the separate V2.3 canonicalization PR.
5. Require exact-head deterministic checks, independent review, finding reconciliation, final live race, merge, and post-merge activation.
6. Only after canonicalization may later roadmap work use V2.3 as canonical planning authority.
