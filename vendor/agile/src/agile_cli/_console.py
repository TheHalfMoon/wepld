"""Base Rich/Typer console layer for the agile CLI.

This module is the single source of Rich ``Console`` instances and Typer UI
helpers used throughout ``agile_cli``.  Nothing in this file should import
from other ``agile_cli`` sub-modules; all dependencies must flow *into* this
