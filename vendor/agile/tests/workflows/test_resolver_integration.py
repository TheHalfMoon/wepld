...
from agile_cli.workflows.overlays import WorkflowResolver
from agile_cli.workflows.overlays.merge import ComposedStep
                ...
                "edits": [
                    {
                        ...
                        "anchor": "a",
                        "step": {"id": "new", "type": "command", "command": "agile.plan"},
                    }
                ],
            },
        )
