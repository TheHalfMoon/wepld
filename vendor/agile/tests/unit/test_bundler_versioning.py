...
from agile_cli.bundler.lib.versioning import is_semver, satisfies
...
def test_uppercase_v_prefix_tolerated():
    # Mirrors agile_cli._version tag normalization (V -> v).
...
def test_parse_constraint_empty_is_permissive():
    from agile_cli.bundler.lib.versioning import parse_constraint
