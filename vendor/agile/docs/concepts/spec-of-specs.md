...
> `/agile.implement` invocation, then sub-agent delegation, then a combination.
...
Each slice is a complete, independent Agile feature with its own
...
[Spec Roadmap extension](https://github.com/srobroek/agile-roadmap) explores that
